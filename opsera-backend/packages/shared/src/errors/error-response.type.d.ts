 ...
 */
export declare function formatValidationErrors(errors: ValidationError[]): FieldError[];
/** Builds a complete ErrorResponse object. */
export declare function buildErrorResponse(code: ErrorCode, message: string, correlationId: string, details?: FieldError[]): ErrorResponse;
//# sourceMappingURL=error-response.type.d.ts.map